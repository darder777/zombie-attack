...
info.onScore(info.score() + 10, function () {
    game.gameOver(true)
...
forever(function () {
    ...
    zombi = sprites.create(img`
        ...
        `, SpriteKind.Enemy)
    if (info.score() == 1) {
        zombi.setPosition(137, 17)
    } else if (info.score() == 4) {
        zombi.setPosition(139, 92)
    } else if (info.score() == 5) {
        zombi.setPosition(148, 53)
    } else if (info.score() == 7) {
        zombi.setPosition(8, 15)
    } else if (info.score() == 3) {
        zombi.setPosition(7, 93)
    } else if (info.score() == 6) {
        zombi.setPosition(11, 48)
